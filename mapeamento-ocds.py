...
## Contratações
contratacoes_q1 = pd.read_csv('coleta/data-package/2025_/1 - Janeiro/QUINZENA-1/DATA/contratacoes.csv')
contratacoes_q2 = pd.read_csv('coleta/data-package/2025_/1 - Janeiro/QUINZENA-2/DATA/contratacoes.csv')
...
## Itens
itens_q1 = pd.read_csv('coleta/data-package/2025_/1 - Janeiro/QUINZENA-1/DATA/itens-medicamentos.csv')
itens_q2 = pd.read_csv('coleta/data-package/2025_/1 - Janeiro/QUINZENA-2/DATA/itens-medicamentos.csv')
itens = pd.concat([itens_q1, itens_q2], ignore_index=True)
### Removendo duplicatas
itens = itens.drop_duplicates()

## Resultados
resultados_q1 = pd.read_csv('coleta/data-package/2025_/1 - Janeiro/QUINZENA-1/DATA/itens-medicamentos-resultados.csv')
resultados_q2 = pd.read_csv('coleta/data-package/2025_/1 - Janeiro/QUINZENA-2/DATA/itens-medicamentos-resultados.csv')
...
for estado in releases:
    ...
    # Exportar para Zip
    with zipfile.ZipFile(f"{id}-json.zip", "w", zipfile.ZIP_DEFLATED) as zipf:

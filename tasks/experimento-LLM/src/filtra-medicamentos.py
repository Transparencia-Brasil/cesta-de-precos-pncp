...
PATH_ITENS = "../inputs/demais-items.csv"
PATH_CATALOGO = "../../../data/catmat/catmat.csv"

# Diretórios dos arquivos de entrada (onde serão salvos os arquivos gerados)
dir_itens = os.path.dirname(PATH_ITENS)
dir_catalogo = os.path.dirname(PATH_CATALOGO)

# Carrega os dados
catmat_df = pd.read_csv(PATH_CATALOGO)  # CATMAT
itens_df = pd.read_csv(PATH_ITENS)      # Itens PNCP
...
medicamentos_df_bkp = medicamentos_df
